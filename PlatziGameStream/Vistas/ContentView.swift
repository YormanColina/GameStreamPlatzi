...
//  PlatziGameStream
//
//  Created by Yorman Colina on 12/05/22.
//
...
//  GameStream
//
//  Created by Yorman Colina on 28/04/21.
//
...
struct RegistroView: View {
    ...
    func registrarse()  {
        if contraseña == confirmacionContraseña{
            ...
            let _ = objetoActualizadorDatos.guardarDatos(correo: correo, contrasena: contraseña, nombre: "")
        }
    }
}
